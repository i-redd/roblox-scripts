...
do
	...
	local IMGUIWindow = library:AddWindow("Skidassist v2", {
	...
	do
		...
		anotherTab:AddLabel("warlock#0003 for universal-lizing")
		anotherTab:AddLabel("zxciaz on github for the aimlock")
		anotherTab:AddLabel("kiriot for the esp (?)")
        ...
        local aimlockEnable = aimlockTab:AddSwitch("Airshot function", function(state)
            getgenv().CheckIfJumped = state
        end)

		        local aimlockEnable = aimlockTab:AddSwitch("Team check", function(state)
		...
		anotherTab:AddLabel("retoggle the settings, niggas retarded")
		...
		local triggerbotEnable = miscTab:AddSwitch("Trigger Bot (SLaggy shit)", function(state)
		...
		miscTab:AddTextBox("Antilock speed (-0.10 & -0.60))", function(a)
